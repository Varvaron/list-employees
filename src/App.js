...
function App() {
  const data = [
    ...
    {name: 'Сомова Ксения', salary: 1200, increase: false, id: 2},
    {name: 'Борисов Тимур', salary: 1500, increase: false, id: 3},
    {name: 'Николас Мартинес', salary: 3500, increase: false, id: 4}
  ];
